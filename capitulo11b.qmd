...
![Editando Elementos](image/cap11/editando-elementos-1.jpeg){#fig-editando-elementos}

![Em edição](image/cap11/elementos-em-edicao.jpeg){#fig-elementos-em-edição}

:::

::: {.callout-note title=@fig-editando-elementos}
...
![Criando um novo ponto](image/cap11/add-ponto.jpeg){#fig-add-ponto}

::: {.callout-note title=@fig-add-ponto}
...
![Formulário de atributos](image/cap11/form-1.jpeg){#fig-form1}

O formulário está dividido em abas, seções e campos.

::: {.callout-note title=@fig-form1}
...
![Dados principais](image/cap11/form-principal-localizacao.jpeg){#fig-form-principal-localizacao}

::: {.callout-note title=@fig-form-principal-localizacao}
...
![Origem da informação](image/cap11/origem-informacao.jpeg){#fig-origem-informacao}  
::: 
